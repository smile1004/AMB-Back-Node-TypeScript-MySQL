...
const { JobInfoStaffInfo, JobInfo } = db;
 ...
 */
const getStaffInfo = async (req: any, res: any, next: any) => {
  try {
 ...
 */
const getStaffInfoById = async (req: any, res: any, next: any) => {
  try {
    const { id } = req.params;
 ...
 */
const createStaffInfo = async (req: any, res: any, next: any) => {
  try {
    const { jobId } = req.params;
    const {
      post,
 ...
 */
const updateStaffInfo = async (req: any, res: any, next: any) => {
  try {
    const { id } = req.params;
    const {
      post,
 ...
 */
const deleteStaffInfo = async (req: any, res: any, next: any) => {
  try {
    const { id } = req.params;
