 ...
 */
const getAllChats = async (req: any, res: any, next: any) => {
  try {
 ...
 */
const getChatMessages = async (req: any, res: any, next: any) => {
  try {
    ...
    if (
      (role === 'jobSeeker' && chat.job_seeker_id !== userId) ||
 ...
 */
const startChat = async (req: any, res: any, next: any) => {
  try {
