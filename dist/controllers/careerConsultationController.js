 ...
 */
const getCareerConsultations = async (req, res, next) => {
    try {
 ...
 */
const getCareerConsultationById = async (req, res, next) => {
    try {
        const { id } = req.params;
 ...
 */
const createCareerConsultation = async (req, res, next) => {
    try {
 ...
 */
const deleteCareerConsultation = async (req, res, next) => {
    try {
        const { id } = req.params;
        const careerConsultation = await CareerConsultation.findByPk(id);
        if (!careerConsultation) {
